...
<body oncontextmenu="event.preventDefault()" onresize="item.refresh()">
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/cytoscape/3.2.11/cytoscape.min.js" 		 type="text/javascript"></script>
    <script src="https://cdn.rawgit.com/maxkfranz/weaver/v1.2.0/dist/weaver.min.js" 			 type="text/javascript"></script>
    <script src="https://cdn.rawgit.com/cytoscape/cytoscape.js-spread/1.3.1/cytoscape-spread.js" type="text/javascript"></script-->
    
    <script type="text/javascript" src="vendor/ogma/ogma.min.js"></script>
