...
$aData['json_data'] = json_encode(array(
		'operation' => 'core/get',
		'class' => 'VirtualDevice',
		'key' => 'SELECT VirtualDevice',
		'output_fields' => 'id, friendlyname',
	));
// Obtenir tous les logiciels installés
$aData['json_data'] = json_encode(array(
		'operation' => 'core/get',
		'class' => 'SoftwareInstance',
		'key' => 'SELECT SoftwareInstance',
...
// Obtenir toutes les familles de services
$aData['json_data'] = json_encode(array(
		'operation' => 'core/get',
		'class' => 'ServiceFamily',
